...
class rifle{
    constructor(){
        ...
        this.barrel.setAttribute("position", {x: this.secam.object3D.position.x+1, y:this.secam.object3D.position.y-.5, z:this.secam.object3D.position.z-3});
        this.barrel.setAttribute("rotation", "90 90 90");
        this.barrel.setAttribute("scale", ".3 3 .3");
        this.bullet.setAttribute("position", {x: this.secam.object3D.position.x+1, y:this.secam.object3D.position.y-.5, z:this.secam.object3D.position.z-8});
        this.bullet.setAttribute("rotation", "0 90 -90");
        this.bullet.setAttribute("scale", ".3 3 .3");
        this.secam.append(this.barrel);
        this.secam.append(this.bullet);
    }
}